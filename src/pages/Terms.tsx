...
const TermsOfService: React.FC = () => {
  return (
    <div className="mt-5 mb-5 p-6 mx-auto">
      ...
      <p className="mb-4">
        Bienvenido a Hogar Animal. Al acceder o utilizar nuestro sitio web [www.hogar-animal.com], aceptas cumplir y estar sujeto a los siguientes términos y condiciones ("Términos de Servicio"). Si no estás de acuerdo con estos términos, no debes utilizar nuestro sitio.
      </p>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">2. Propiedad Intelectual</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">3. Enlaces a Sitios de Terceros</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">5. Modificaciones a los Términos</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">6. Terminación</h2>
      <p className="mb-4">
