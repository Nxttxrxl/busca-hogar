...
const Resultados: React.FC = () => {
  ...
  const animalData = {
    ...
    age: '3 años', 
    gender: 'M',
    description: 'Es un perro amistoso y enérgico que disfruta de jugar y correr al aire libre.', 
  };
      ...
      <div className="w-full max-w-4xl p-6 bg-white shadow-md rounded-lg mb-6">
        <div className="flex items-center space-x-6">
          ...
          <div>
            ...
            <p className="text-lg mb-1"><strong>Género:</strong> {animalData.gender}</p>
